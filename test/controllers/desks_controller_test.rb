...
class DesksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create desk" do
    assert_difference('Desk.count') do
      post desks_url, params: { desk: { location: @desk.location, name: @desk.name, time: @desk.time } }
    end
  ...
  test "should update desk" do
    patch desk_url(@desk), params: { desk: { location: @desk.location, name: @desk.name, time: @desk.time } }
